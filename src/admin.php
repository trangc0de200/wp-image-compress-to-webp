...
function wicw_render_dashboard_page()
{
    ...
    ?>
    <div class="wrap">
        <h1><?php echo esc_html__('WP Image Compress To WebP Dashboard', 'wp-image-compress-to-webp'); ?></h1>
        <p><?php echo esc_html__('This plugin automatically converts uploaded JPG/JPEG/PNG images to WebP.', 'wp-image-compress-to-webp'); ?></p>
        <p><?php echo esc_html(wicw_license_local_validation_description()); ?></p>
        ...
        <h2><?php echo esc_html__('License', 'wp-image-compress-to-webp'); ?></h2>
        <p>
